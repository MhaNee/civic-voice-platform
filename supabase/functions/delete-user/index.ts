...
import { createClient } from "https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2.36.0/dist/module/index.js";
...
serve(async (req) => {
  ...
  try {
    ...
    // the profile row will be removed by caller if necessary
