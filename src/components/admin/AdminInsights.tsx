    ...
    return (
        <div className="space-y-8">
            <div className="flex items-start justify-between">
                <div>
                    <h2 className="font-display text-2xl font-bold text-foreground">Legislative Insights</h2>
                    <p className="text-muted-foreground">AI-generated briefing for policymakers based on public discourse.</p>
                </div>
                {hasData && (
